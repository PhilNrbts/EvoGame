#' This package generates an evolution process for agents
#'
...
#'
#'@details For information each data frame column and information about the underlying generating process, see the github README.md file \url{https://github.com/PhilNrbts/Evo_simulation/blob/master/README.md}.
#' @docType package
#' @name EvoGame
NULL
